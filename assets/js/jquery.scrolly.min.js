/* jquery.scrolly v1.0.0-dev | Roltres | MIT licensed */
(function (e) {
    // Function to calculate the target scroll position
    function u(s, o) {
      var u, a, f;
    ...
    // Variables used for shorthand references
    var t = "length",
      n = null,
      r = "top",
      i = "offset",
    ...
    // Attach scrolly function to jQuery prototype
